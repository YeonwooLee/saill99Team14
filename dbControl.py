...
client = pymongo.MongoClient(
    'mongodb+srv://sail99Team14:sail99pw14@cluster0.zlqekaz.mongodb.net/?retryWrites=true&w=majority', tlsCAFile=ca)
db = client.dbCovid
...
def get_one_covid(insertAt):
    return db['covidAlert'].find_one({'insertAt': insertAt},{'_id':False})
...
if __name__ == "__main__":
    print(type(get_one_covid(1656546117223814700)))
